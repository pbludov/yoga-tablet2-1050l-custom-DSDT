 ...
 *
 * Disassembly of DSDT, Wed Dec 30 16:46:36 2015
 *
  ...
  Scope (_SB)
  {
      Device (LPEA)
      {
          ...
          Device (SSP1)
          {
              ...
              Method (_STA, 0, Serialized)  // _STA: Status
              {
                  If (OSSL == One && (BDID == 0x02 || BDID == 0x03 || BDID == 0x04))
                  {
                      Return (0x0F)
                  }
          ...
          Device (TCS0)
          {
              ...
              Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
              {
                  Name (RBUF, ResourceTemplate ()
                  {
                      I2cSerialBus (0x0038, ControllerInitiated, 400000,
                          ...
                          0x00, ResourceConsumer, , )
                      GpioIo (Exclusive, PullDefault, 0x0000, 0x0000, IoRestrictionOutputOnly,
                          "\\_SB.GPO0", 0x00, ResourceConsumer, , ) { 60 }
                      GpioIo (Exclusive, PullDefault, 0x0000, 0x0000, IoRestrictionOutputOnly,
                          "\\_SB.GPO1", 0x00, ResourceConsumer, , ) { 3 }
                      GpioInt (Level, ActiveHigh, Exclusive, PullDefault, 0x0000,
                          "\\_SB.GPO2", 0x00, ResourceConsumer, , ) { 12 }
                  })
              ...
              Name (_DSD, Package ()
              {
                  ToUUID("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"), Package () {
                      Package (2) {"reset-gpio", Package() {^TCS0, 0, 0, 0 }},
                      Package (2) {"power-gpio", Package() {^TCS0, 1, 0, 0 }},
                      Package (2) {"irq-gpio",   Package() {^TCS0, 2, 0, 0 }},
                  }
              })
/*
              Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
